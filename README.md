...
**Figure 2.** Showcases the top-k accuracy values for different Splice AI versions as well as other similar splice-predicting softwares. *(Illumina, n.d.)*
...
**Figure 3.** Gives an overview of how the deep learning model works and produces output scores. *(Illumina, n.d.-b)*
...
**Figure 4.** Shows an example where Splice AI-10k accurately predicts all 26 acceptor sites and all 26 donor sites for the CFTR gene, unlike another software known as MaxEntScan, which utilizes a very narrow/local window during analysis. *(Illumina, n.d.-c)*
...
<img width="600" height="600" alt="image" src="https://assets.illumina.com/content/dam/illumina-marketing/images/genomics-research/articles/splice-ai/figure-4.jpg"/>

**Figure 5.** Showcases how Splice AI-10k compares reference transcript with variant transcript and calculates DS_AG and DS_AL. *(Illumina, n.d.-d)*
